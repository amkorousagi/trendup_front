...
**/
class LoadGEXF extends _react.default.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return _react.default.createElement("div", null, (0, _tools.embedProps)(this.props.children, {
