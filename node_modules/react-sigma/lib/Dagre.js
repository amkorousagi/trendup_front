...
**/
const Dagre = props => !!props.sigma ? _react.default.createElement(_ReactSigmaLayoutPlugin.default, _extends({
...
Dagre.propTypes = {
  directed: _propTypes.default.bool,
  multigraph: _propTypes.default.bool,
  compound: _propTypes.default.bool,
  rankDir: _propTypes.default.oneOf(["TB", "BT", "RL", "LR"]),
  easing: function () {
