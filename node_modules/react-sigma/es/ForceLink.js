...
function (_React$Component) {
  ...
  function ForceLink() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ForceLink)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "render", function () {
      ...
      return React.createElement("div", null, embedProps(_this.props.children, {
